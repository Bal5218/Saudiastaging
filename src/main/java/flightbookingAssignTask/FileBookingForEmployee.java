...
//		QaBrowser.driver.switchTo().defaultContent();
		...
		PassengerPage.flightPassengerPage(TripType, BookAs, TCategory, Aqty, firstName, lastName, DateOfBirth,
				DateOfbirth1, DateOfbirth2, Cqty, Iqty, ISQty, SelectOption);

		ExtrasPage.SelectExtras(TripType, Aqty, Cqty, Iqty, ISQty, NextFlight, NextFlightBaggage, NoExtra, SelectExtras,
				MulticityFasttrack, SeatD, SeatR, SeatNo, ReturnSeatNumber, DepartureSeat2, DepartureSeat3,
				Baggageradiobutton);
		PaymentPage.paymentPage(TripType, PaymentMethod, CardNumber, NameOfCardHolder, CVV);
